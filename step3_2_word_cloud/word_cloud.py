...
f = open('data_full.dat', 'r',encoding='utf-8')

for i in f:
    lyric += f.read()

result = jieba.analyse.textrank(lyric, topK=20, withWeight=True)
...
wc = WordCloud(font_path='Songti.ttc', background_color='White', max_words=20, mask=graph)
