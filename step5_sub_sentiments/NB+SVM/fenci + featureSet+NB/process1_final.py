...
def featureSelect():
    ...
    for word_emotion in emotion_WordFreq:
        ...
        if word_emotion in none_emotion_WordFreq: 
    ...
    for word_none_emotion in none_emotion_WordFreq:
        ...
        if word_none_emotion in emotion_WordFreq:
...
#    f=open('dic_intention_polarity.txt','r')
    f=open('kafang1','r',encoding='utf-8')
    for line in f.readlines():
        lineSet=line.strip().split()
...
def for_weight(lineSet,dic_intention_polarity,a,b):
    ...
    for word in lineSet:
        ...
        if word in dic_intention_polarity:
            for i in range(0,21):
...
def train_for_libsvm(fileName,fileName1,dic_intention_polarity,a,b):
    ...
    f2=open('train_emotion_label.txt','r',encoding='utf-8')
...
def train_for_nb(file_in,file_out):
    featureSet=featureSelect()
    train_label=[]
    f_label=open('train_label_int.txt','r',encoding='utf-8')
...
if __name__=='__main__': 
    ...
    merge_result("NB_SVM_RESULT1","result_emotion_mu.txt","test.out5")
